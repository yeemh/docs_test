...
- 실행 파일 위치 : tutorial/thanosql_ml/classification/classification_electra.ipynb  
...
* [나만의 텍스트 분류 모델 배포하기](https://docs.thanosql.ai/how-to_guides/ThanoSQL_connecting/thanosql_api/rest_api_thanosql_query/)
